...
# by David Matuszek and Tse-Lun Hsu (ID: 61737979).
...
def location_to_string(location):
    ...
    return str(chr(location[0] + 65)) + str(location[1] + 1)
...
def all_locations():
    ...
    for i in range(0, 5):
        for j in range(0, 5):
            all_25_locations.append((i, j))
    return all_25_locations
...
def is_legal_move_by_musketeer(location, direction):
    ...
    if direction == "up" and is_within_board(location, direction):
        if at((location[0] - 1, location[1])) == "R":
            return True
        else:
            return False
    if direction == "down" and is_within_board(location, direction):
        if at((location[0] + 1, location[1])) == "R":
            return True
        else:
            return False
    if direction == "left" and is_within_board(location, direction):
        if at((location[0], location[1] - 1)) == "R":
            return True
        else:
            return False
    if direction == "right" and is_within_board(location, direction):
        if at((location[0], location[1] + 1)) == "R":
            return True
        else:
            return False
...
def possible_moves_from(location):
    ...
    if at(location) == "M":
        if is_legal_move(location, "up"):
            all_possible_moves.append("up")
        if is_legal_move(location, "down"):
            all_possible_moves.append("down")
        if is_legal_move(location, "right"):
            all_possible_moves.append("right")
        if is_legal_move(location, "left"):
            all_possible_moves.append("left")
...
def can_move_piece_at(location):
    ...
    if at(location) == "R":
        if at((location[0] - 1, location[1]))  == "-" or at((location[0] + 1, location[1]))  == "-" or at((location[0], location[1] + 1))  == "-" or at((location[0], location[1] - 1)) == "-":
            return True
        else:
            return False
    elif at((location)) == "M":
        if at((location[0] - 1, location[1])) == "R" or at((location[0] + 1, location[1])) == "R" or at((location[0], location[1] + 1)) == "R" or at((location[0], location[1] - 1)) == "R":
            return True
        else:
            return False
    else:
...
def is_legal_location(location):
    ...
    if location[0] >= 0 and location[0] <= 4 and location[1] >= 0 and location[1] <= 4:
        return True
    else:
        return False
...
def all_possible_moves_for(player): 
    ...
    for location in all_locations():
        possible_move = possible_moves_from(location)
        for element in possible_move:
            if is_legal_move(location, element) == True:
                row = location[0]
                col = location[1]

                if board[row][col] == "M":
                    location_one.append((location, element))
                if board[row][col] == "R":
                    location_two.append((location, element))
...
def make_move(location, direction):
    ...
    if at(location) == "M":
        ...
        if direction == "up":
            board[location[0]-1][location[1]] = "M"
            return (location[0] - 1, location[1])
        elif direction == "down":
            board[location[0]+1][location[1]] = "M"
            return (location[0] + 1, location[1])
        elif direction == "right":
            board[location[0]][location[1]+1] = "M"
    ...
    if at(location) == "R":
        board[location[0]][location[1]] = "-"
        if direction == "up":
            board[location[0]-1][location[1]] = "R"
            return (location[0] - 1, location[1])
        elif direction == "down":
            board[location[0]+1][location[1]] = "R"
            return (location[0] + 1, location[1])
        elif direction == "right":
            board[location[0]][location[1]+1] = "R"
            return (location[0], location[1] + 1)
        else:
            board[location[0]][location[1]-1] = "R"
            return (location[0], location[1] - 1)
...
def choose_computer_move(who):    
    ...
    computer_move = []
    computer_move = all_possible_moves_for(who)
...
def is_enemy_win():
    ...
    for location in all_locations():
        if at(location) == "M":
            all_possible_move_M.append(location)
    if all_possible_move_M[0][0] == all_possible_move_M[1][0] == all_possible_move_M[2][0] or all_possible_move_M[0][1] == all_possible_move_M[1][1] == all_possible_move_M[2][1] :
        return True
    else:
        return False
